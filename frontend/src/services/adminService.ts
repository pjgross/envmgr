...
export const adminService = {
  ...
  disableTenant: (id: number) =>
    api.post<TenantResponse>(`/admin/tenants/${id}/disable`).then((r) => r.data),
  ...
  setTenantUserRole: (tenantId: number, userId: number, role: string) =>
    api
      .patch<UserResponse>(`/admin/tenants/${tenantId}/users/${userId}/role`, { role })
      .then((r) => r.data),
  deactivateTenantUser: (tenantId: number, userId: number) =>
    api
      .post<UserResponse>(`/admin/tenants/${tenantId}/users/${userId}/deactivate`)
      .then((r) => r.data),
  reactivateTenantUser: (tenantId: number, userId: number) =>
    api
      .post<UserResponse>(`/admin/tenants/${tenantId}/users/${userId}/reactivate`)
      .then((r) => r.data),
  resetUserPassword: (tenantId: number, userId: number, newPassword: string) =>
    api
      .post<UserResponse>(`/admin/tenants/${tenantId}/users/${userId}/reset-password`, {
  ...
  signInAsTenant: (tenantId: number) =>
    api
      ...
      }>(`/admin/tenants/${tenantId}/sign-in-as`)
      .then((r) => r.data),
};
