...
export default function TenantSettings() {
  ...
  return (
    <Box sx={{ p: 3 }}>
        ...
        {settings && (
          <Paper sx={{ p: 2, mb: 2 }}>
            <Typography variant="body1"><strong>Name:</strong> {settings.name}</Typography>
            <Typography variant="body1"><strong>Slug:</strong> {settings.slug}</Typography>
          </Paper>
        )}
        ...
        {loading ? (
          ...
          <Paper sx={{ p: 3 }}>
            <Typography variant="h6" gutterBottom>Custom Settings (JSON)</Typography>
