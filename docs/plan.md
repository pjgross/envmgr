...
| 7 | Multi-Project Coordination **+ Environment Lifecycle & Governance** | ✅ Complete (2026-08-19, expanded 2026-07-16) — both programmes, ten sub-projects: A1 projects + usage agreements, A2 environment groups, A3 agreement warnings, A4 project-aware contention, B1 governance fields, B2 naming + quarantine, B3a/B3b user groups + request form, B4 soft/hard reservations, B5 decommissioning + idle detection, B6 forward contention (merge `3a048f8a`). Nothing outstanding | 6–8 weeks | [phases/phase-7.md](phases/phase-7.md) |
